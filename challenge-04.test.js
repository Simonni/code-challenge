...
const matchMonth = (input) => {
  // Solution code here...
  let regex = /[A-Z]\w*/ig 
  let str = input.match(regex)
  let inputArr = str.join()
  if(inputArr === 'October'||inputArr==='october' ||
  inputArr === 'Oct'||inputArr=== 'oct'){
    return true
  } else {
    return false
  }
